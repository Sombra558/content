...
MARKERS: list[tuple[int, str, str]] = [
    ...
    (30, "Know when to escalate a situation", "Debes rechazar el servicio en las siguientes situaciones"),
    ...
    (62, "Support ethical service by", "Respaldar el servicio ético"),
    ...
    (66, "Maintain professionalism by", "Para ser profesional"),
